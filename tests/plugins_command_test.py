...
def test_install_guides_explain_manual_and_agent_assisted_paths():
    ...
    assert OLD_AGENT_BARK_NOTIFY_PREFIX not in codex.output
    assert OLD_AGENT_BARK_NOTIFY_PREFIX not in claude.output
    assert OLD_AGENT_BARK_NOTIFY_PREFIX not in openclaw.output
